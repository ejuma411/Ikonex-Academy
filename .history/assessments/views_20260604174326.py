...
from .models import Assessment, Score, Student, ClassStream
...
def class_result_view(request, class_id):
    class_stream = get_object_or_404(ClassStream, pk=class_id)
    ...
    for student in students:
        scores = Score.objects.filter(student=student).select_related('assessment', 'subject')
    ...
    return render(request, 'assessments/results/class_result.html', {
